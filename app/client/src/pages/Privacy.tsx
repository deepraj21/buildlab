              ...
              <div className="min-h-screen text-foreground p-4">
                  <div className="max-w-4xl mx-auto">
                    <AuroraText className='text-5xl items-center gap-2' ><Atom className='h-11 w-11' /> buildlab</AuroraText>
                      <h1 className="text-4xl mt-6 mb-6">Privacy Policy</h1>
                      <p className="text-muted-foreground mb-8">Last updated: January 21, 2025</p>
                      <div className="pr-4">
                          <section className="mb-8">
                              <h2 className="text-2xl mb-4">Introduction</h2>
                              <p>Welcome to BuildLab. We value your privacy and are committed to protecting the personal information you share with us. This Privacy Policy explains how we collect, use, and safeguard your data when you visit our website or interact with our services.</p>
                          </section>
                          ...
                          <section className="mb-8">
                              <h2 className="text-2xl  mb-4">Your Data Rights</h2>
